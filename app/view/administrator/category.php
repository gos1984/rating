	...
	<div class="col-12">
		<div class="content">
			<div class="table">
				...
				<form class="tr" action="/administrator/edit/category?action=add" method="POST">
					<div class="td"></div>
				...
				<?php foreach ($data as $key => $value): ?>
					<form class="tr" action="/administrator/edit/category?action=edit" method="POST">
						...
						<div class="td"><a href="<?php echo "/administrator/edit/category?action=remove&id=$key" ?>" class="btn btn-danger">Удалить</a></div>
					</form>
				<?php endforeach ?>
			</div>
		</div>
