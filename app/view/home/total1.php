  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        ...
        <p class="slogan">30 апреля 2019 года в соответствии с методологией рейтинга<br/> опубликованы предварительные
результаты автоматической программной проверки. </p>
          <p class="slogan">В списке отделения расположены в порядке ранжирования по баллам.<br/> Финальные результаты рейтинга будут опубликованы 20 мая 2019 года после верификации и экспертизы результатов.</p>
          ...
          <?php if ($data['items']): ?>
            <tbody>
              <?php foreach ($data['nominations'] as $n => $nomination): ?>
                <tr>
                  <td colspan="5"><h3><?php echo $nomination; ?></h3></td>
                  <?php foreach ($data['description'] as $key => $val): ?>
                    <?php if ($val['nomination'] == $n): ?>
                      <tr>
                        ...
                        <td class="city"><?php echo $val['city']; ?></td>
                        <td class="ball center"><?php echo $val['ball']; ?></td>
